...
export const getServerSideProps: GetServerSideProps = async (
  ...
  return {
    props: {
      // user: res.user, userFetchError: res.error || null
    },
  }
}
        ...
        <div className="px-4 py-8 mt-8 sm:shadow-lg shadow-base-content/10 sm:rounded-lg sm:px-10 sm:mx-auto sm:w-full sm:max-w-md sm:bg-base-200">
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center mt-6">
              <button
                className={classNames(
                  'justify-center items-center w-full btn',
                  {
                    loading: loading,
                  }
                )}
          ...
          {/* <div className="mx-auto mt-4 whitespace-pre-wrap break-all card bg-base-300">
            ...
            <div className="p-4 text-xs card-body">
              ...
              <span>
                error:{' '}
                {JSON.stringify(userFetchError || 'none', undefined, ' ')}
              </span>
              <span className="m-0 divider divider-vertical"></span>
              <span>
                redirect base:{' '}
