...
interface EditorAttrs extends ProjectUpdateAttrs {
  onUpdate: (attrs: ProjectUpdateAttrs) => void
}

const ProjectUpdateEditorComponent = ({
  question,
  options = [],
  correctAnswer,
  onUpdate,
  ...
  return (
    <>
      <TextareaAutosize
        autoFocus
        className="w-full p-4 mx-2 overflow-hidden text-lg font-bold leading-tight tracking-tighter border-0 rounded resize-none"
        value={question}
...
export default ProjectUpdateEditorComponent
